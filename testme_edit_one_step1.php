    ...
    <div id="poststuff">
        ...
        <div class="postbox">
            ...
            <div class="inside">
                ...
                <?php wp_editor(stripcslashes($testme_test_details->test_description), 'test_description'); ?>
        ...
        <div class="postbox testme_show_test_description2">
            ...
            <div class="inside">
                ...
                <?php wp_editor(stripcslashes($testme_test_details->test_description_2), 'test_description_2'); ?>
...
<?php var_dump('<pre>', $testme_test_details, '</pre>') ?>
        <div class="postbox" id="titlediv">
            ...
            <div class="inside">
                <p><input type="radio" name="test_type" value="abc" id="testme_abc" <?php
                    if ($testme_test_details->test_type == 'abc') {
                        print 'checked="checked"';
                    }
                    ?> /> <label for="testme_abc"><strong>Абв</strong> - тест, где каждому ответу присваивается буква или цифра, и результат зависит от того, каких букв (цифр) будет больше среди ответов. (Например, А - холерик, Б - сангвиник, В - флегматик и т.д.) Подходит к тестам типа "Кто ты".</label></p>
                <p><input type="radio" name="test_type" value="123" id="testme_123" <?php
                    if ($testme_test_details->test_type == '123') {
                        print 'checked="checked"';
                    }
                    ?> /> <label for="testme_123"><strong>123</strong> - тест, где каждому ответу присваивается некоторое колличество баллов, и результат зависит от суммы. Этот тип теста подходит к тестам, нде надо измерить степень какого-то качества, например "Насколько ты ревнива" или "Ты смелая или стеснительная".</label></p>
        ...
        <div class="postbox" id="testme_params_div">
            ...
            <div class="inside">
				<p><input name="test_display_rez" id="test_display_rez" type="checkbox"  value="1"
                    <?php
                    if ($testme_test_details->test_display_rez == 1) {
                        print 'checked="checked"';
                    }
                    ?>
                          /> <label for="test_display_rez">
                        Показыва правильные/неправильные ответы по завершению.</label></p>                			
                ...
                <p><input name="test_post" id="test_post" type="text"  value="<?php echo $testme_test_details->test_post ?>" /> <label for="test_post">(Заполняется автоматически) Номер прикрепленной записи</p>
