...
// Скрипты для подгрузки
                ...
                if ($testme_results) {
                    foreach ($testme_results as $result) {
                        $i++;
                        print '<div class="testme_result_block"><p><strong>Результат ' . $i . ':</strong></p>';
                ...
                style="background-color:#e7ffe7" maxlength="3" />
                        ...
                        <p>Картинка: <input class="upload_image" type="text" name="result_image[<?php echo $result->ID ?>]" value="<?php echo $result->result_image ?>" style="width:500px" />
                            ...
                            Выравнивание: <select name="result_image_position[<?php echo $result->ID ?>]">
                                ...
                                if ($result->result_image_position == 'alignleft') {
                                    print 'selected="selected"';
                                }
                                ?>>Слева</option>
                                <option value="aligncenter" <?php
                                if ($result->result_image_position == 'aligncenter') {
                                    print 'selected="selected"';
                                }
                                ?>>Посередине</option>
                                <option value="alignright" <?php
                                if ($result->result_image_position == 'alignright') {
                                    print 'selected="selected"';
                                }
                                ?>>Справа</option>
                            </select>
                        ...
                        <p>Описание: <br />
                            <textarea name="result_text[<?php echo $result->ID ?>]" rows="4" cols="50" style="width:100%"><?php echo stripcslashes($result->result_text) ?></textarea></p>
